  ...
  const validateField = (name, value) => {
    ...
    if (name === "first_name") {
      ...
      if (!value) {
        ...
        error = true;
        helperText =
          "You are allowed to book minimum 1 seat and maximum 10 Seats";
      }
    } else if (name === "date") {
      if (!value) {
        error = true;
  ...
  return (
    ...
    >
      <Grid container alignItems="center" justify="center" direction="row">
        <Grid item>
          {movieBooking.status === "BOOKED" && (
            <Alert severity="success">Booked the ticket(s) successfully</Alert>
          )}
          {movieBooking.message && (
            <Alert severity="error">{movieBooking.message}</Alert>
          )}
        </Grid>
      </Grid>
      <div className="flex flex-col justify-center items-center content-center w-full h-full">
        <div>
          <Card className="booking-form-card !bg-[#ffffffaa]">
            ...
            <div className="flex flex-col justify-center items-center content-center">
              ...
              <div item className="booking-form-item">
                <div className="padding10">
                  <KeyboardDatePicker
                    name="date"
                    fullWidth
                    onChange={(value) =>
                      onChangeHandler({ target: { name: "date", value } })
                    }
              ...
              <div className="booking-form-item">
                <Button
                  ...
                  disabled={movieBooking.status === "BOOKED"}
                  fullWidth
                >
                  {" "}
                  Book{" "}
